...
type ShutdownGridReq struct {
	...
	GridId int32 `protobuf:"varint,2,opt,name=gridId,proto3" json:"gridId,omitempty"`
}
...
func (x *ShutdownGridReq) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *ShutdownGridReq) GetGridId() int32 {
	if x != nil {
		return x.GridId
	}
	return 0
...
var file_SgridPackage_proto_rawDesc = []byte{
	...
	0x3b, 0x0a, 0x0f, 0x53, 0x68, 0x75, 0x74, 0x64, 0x6f, 0x77, 0x6e, 0x47, 0x72, 0x69, 0x64, 0x52,
	0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x03, 0x70, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x67, 0x72, 0x69, 0x64, 0x49, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x67, 0x72, 0x69, 0x64, 0x49, 0x64, 0x32, 0xcd, 0x02, 0x0a,
	...
	0x2e, 0x62, 0x61, 0x73, 0x69, 0x63, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a,
...
var file_SgridPackage_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_SgridPackage_proto_depIdxs = []int32{
	...
	7, // 4: SgridProtocol.FileTransferService.ShutdownGrid:input_type -> SgridProtocol.ShutdownGridReq
	6, // 5: SgridProtocol.FileTransferService.StreamFile:output_type -> SgridProtocol.FileResp
	4, // 6: SgridProtocol.FileTransferService.DeletePackage:output_type -> SgridProtocol.basicResp
	4, // 7: SgridProtocol.FileTransferService.ReleaseServerByPackage:output_type -> SgridProtocol.basicResp
	4, // 8: SgridProtocol.FileTransferService.ShutdownGrid:output_type -> SgridProtocol.basicResp
