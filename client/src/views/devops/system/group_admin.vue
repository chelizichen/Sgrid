    ...
    >
      ...
      <el-table-column prop="name" label="小组名称">
        <template #default="scoped">
          <el-button type="text" @click="toDetail(scoped.row)">{{
            scoped.row.name
          }}</el-button>
        </template>
      </el-table-column>
      <el-table-column prop="total" label="小组总人数"></el-table-column>
...
import { delRole, getGroup, saveRole } from "@/api/system";
...
function toDetail({ createUserId }: any) {
